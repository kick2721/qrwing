          ...
          <div className="flex flex-wrap gap-2">
            {QR_TYPES.map((qt) => (
              <button
                ...
                className={`px-3 py-1.5 rounded-lg text-sm font-medium transition duration-75 active:scale-[0.93] ${
                  qrType === qt.value
          ...
          {canGenerate && (
            <div className="flex flex-wrap gap-2 justify-center">
              <button
                ...
                className="px-5 py-2.5 bg-purple-600 text-white rounded-xl font-medium hover:bg-purple-700 transition duration-75 active:scale-[0.95]"
              >
                {t("downloadPng")}
              </button>
              <button
                onClick={() => downloadQR("svg")}
                className="px-5 py-2.5 bg-gray-100 dark:bg-gray-800 rounded-xl font-medium hover:bg-gray-200 dark:hover:bg-gray-700 transition duration-75 active:scale-[0.95]"
              >
                {t("downloadSvg")}
              </button>
              <button
                onClick={copyToClipboard}
                className="px-5 py-2.5 border border-gray-300 dark:border-gray-700 rounded-xl font-medium hover:bg-gray-50 dark:hover:bg-gray-800 transition duration-75 active:scale-[0.95]"
              >
              ...
              {session?.user && (
                <button
                  onClick={saveQR}
                  disabled={saving}
                  className="px-5 py-2.5 bg-emerald-600 text-white rounded-xl font-medium hover:bg-emerald-700 transition duration-75 active:scale-[0.95] disabled:active:scale-100 disabled:opacity-50"
                >
