      ...
      <div className="w-full max-w-sm">
        ...
        {providers.google && (
          <button
            ...
            className="w-full flex items-center justify-center gap-3 px-5 py-3 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors mb-3"
          >
