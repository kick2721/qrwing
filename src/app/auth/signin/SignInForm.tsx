...
const PROVIDER_NAMES = ["google", "github", "discord", "nodemailer"] as const;
type ProviderName = typeof PROVIDER_NAMES[number];

export default function SignInForm({ available }: { available: ProviderName[] }) {
      ...
      <div className="w-full max-w-sm">
        ...
        {available.includes("google") && (
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 px-5 py-3 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition duration-75 active:scale-[0.98] mb-3 ${clickedProvider === "google" ? "scale-[0.98] opacity-80" : ""}`}
          >
        ...
        {available.includes("github") && (
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 px-5 py-3 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition duration-75 active:scale-[0.98] mb-3 ${clickedProvider === "github" ? "scale-[0.98] opacity-80" : ""}`}
          >
        ...
        {available.includes("discord") && (
          <button
            ...
            className={`w-full flex items-center justify-center gap-3 px-5 py-3 border border-gray-300 dark:border-gray-700 rounded-xl hover:bg-gray-50 dark:hover:bg-gray-800 transition duration-75 active:scale-[0.98] mb-3 ${clickedProvider === "discord" ? "scale-[0.98] opacity-80" : ""}`}
          >
